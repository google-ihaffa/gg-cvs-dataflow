...
import org.apache.beam.DoFn.MutationToGroupMutation;
...
public class GgTrailToSpannerOneToOne {
  ...
  static void runWordCount(WordCountOptions options) {
    ...
    orderedMutations.apply(
        "write Group mutations",
        SpannerIO.write()
