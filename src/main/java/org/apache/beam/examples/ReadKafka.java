...
public class ReadKafka {
    ...
    public static void main(String[] args) {
        ...
        pipeline
                ...
                .apply("Parse and decode the avro messages",MapElements.via(new SimpleFunction<KV<String, byte[]>, String>() {
                    @Override
                ...
                // Print the results
                .apply("Print the records", MapElements.via(new SimpleFunction<String, Void>() {
                    @Override
