...
public class JsonToMutation extends DoFn<String, Mutation> {
  ...
  public Mutation.WriteBuilder fillPrescriptionSplit1MutationBuilder(
    ...
    if (prescriptionFillObject.has("LAST_UPDATED_BY")) {
      mutationBuilder.set("last_updated_by").to(prescriptionFillObject.getString("LAST_UPDATED_BY"));
    }
    ...
    if (prescriptionFillObject.has("IS_ALIGNMENT_FILL")) {
      mutationBuilder
          .set("is_allignment_fill")
          .to(prescriptionFillObject.getLong("IS_ALIGNMENT_FILL"));
    }
    ...
    if (prescriptionFillObject.has("ACTION_TIME")) {
      mutationBuilder.set("action_time").to(prescriptionFillObject.getLong("ACTION_TIME"));
    }
